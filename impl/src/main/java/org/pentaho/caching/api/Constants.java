...
public class Constants {
  ...
  public static final String PENTAHO_CACHE_PROVIDER_EHCACHE = "pentaho.cache.provider.ehcache";
  public static final String PENTAHO_CACHE_PROVIDER_GUAVA = "pentaho.cache.provider.guava";
