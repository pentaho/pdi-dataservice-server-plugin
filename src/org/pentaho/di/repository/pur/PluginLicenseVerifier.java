...
public class PluginLicenseVerifier {
  ...
  public static void verify() {
    try {
      ...
      messagebox.setText(messages.getString(new ObfuscatedString(new long[] { 0x30E2E4A088DE4424L, 0x2D879C295D47AE8L, 0xF6CA345B0F2FBE8FL, 0xD6519406AA783413L, 0x6BFF6F99D967AA4AL, 0x4FF2F7EC3E1F3D76L, 0xD6E2BFFAACC4F634L, 0xD71C5E21ABE2A571L, 0xD0B595C3D287C676L }).toString() /* => "AbsSecurityProvider.ERROR_0005_INVALID_OR_MISSING_PRODUCT_LICENSE" */));
      messagebox.setMessage(messages.getString(new ObfuscatedString(new long[] { 0x7C1A5C05F9D664C9L, 0x86938B18D4442883L,0x50E90B1A4F710720L }).toString() /* => "Dialog.Error" */));
      messagebox.open();
...
//                      0xD6E2BFFAACC4F634L, 0xD71C5E21ABE2A571L, 0xD0B595C3D287C676L }).toString() /* => "AbsSecurityProvider.ERROR_0005_INVALID_OR_MISSING_PRODUCT_LICENSE" */),
