...
public interface IPurgeService {
   ...
   * @param element The element to be pruned
   * @param beforeDate deleted revisions that occurred prior to this date
   ...
   * @param fileId The id of the Node to be pruned.
   * @param beforeDate deleted revisions that occurred prior to this date
   * @throws KettleException
   */
   ...
   * @param element The element whose revision history will be purged.
   * @throws KettleException
   */
   ...
   * @param fileId The id of the repository file whose revision history will be purged.
   * @throws KettleException
   */
   ...
   * @param element The element owning the revision to be purged.
   ...
   * @param fileId The id of the repository file owning the revision history to be purged.
   * @param versionId The version Id to be deleted
   * @throws KettleException
   */
   ...
   * @param element The element owning the revisions to be pruned.
   * @param versionCount The number of revisions to keep.  Note that if the versionCount = 0 then all traces of the file
   * will be removed.
   * @throws KettleException
   */
  ...
  /**
   * Delete all but the nth most recent revisions from the revision history
   * @param fileId The fileId owning the revisions to be pruned.
   * @param versionCount The number of revisions to keep.  Note that if the versionCount = 0 then all traces of the file
   * will be removed.
   * @throws KettleException
   */
   ...
   * @param path The path to delete.  Required unless only the shared objects are to be processed.
   * @param filterMap Allowable keys in filter map are:<br>
   * <ul><li>deleteAll { if true, all versions will be deleted and no other filter items will be checked }</li>
