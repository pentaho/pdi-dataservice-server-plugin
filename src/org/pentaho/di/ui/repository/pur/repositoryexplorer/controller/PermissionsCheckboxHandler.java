...
/**
 * This class aims to handle the enabling, disabling, checking and unchecking of the permissions checkboxes for the PurRepository
 * 
 * @author bryan
 */
public class PermissionsCheckboxHandler {
  /**
   * Class to keep track of relevant checkbox, as well as which checkboxes should be disabled and enabled when this is the highest permission the user has
   * 
   * @author bryan
   */
  private static class PermissionsCheckboxes {
    ...
    /**
     * @param repositoryFilePermission the permission that this object is associated with
     * @param permissionCheckbox the checkbox for the permission
     * @param enabledBoxes the checkboxes that should be enabled when this is the highest permission
     * @param disabledBoxes the checkboxes that should be disabled when this is the highest permission
     */
  ...
  /**
   * Constructs the PermissionsCheckboxHandler by giving it references to the relevant checkboxes
   * The ALL_PERMISSIONS list is used to do cascading permissions, it is important that the permissions
   * are in it in order of highest to lowest
   */
   ...
   * 
   * @param enableAppropriate boolean indicating whether the appropriate boxes should be enabled (set to false to disable all)
   * @param permissionsCheckboxes the permission level object
   */
   ...
   * @param permissionEnumSet the current permissions
   */
  ...
  public void updateCheckboxes(boolean enableAppropriate, EnumSet<RepositoryFilePermission> permissionEnumSet) {
    Set<RepositoryFilePermission> permissions = new HashSet<RepositoryFilePermission>(Arrays.asList(permissionEnumSet
