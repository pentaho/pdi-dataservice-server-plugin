...
//              viewAclsModel.setModelDirty(false);
          ...
          messageBox.setMessage(BaseMessages.getString(PKG, "PermissionsController.UnableToGetAcls", dbconnObject.getName(), ade.getLocalizedMessage()));//$NON-NLS-1$
    ...
    securityBinding = bf.createBinding(connectionsController, "repositoryConnections", userRoleList, "elements", securityBindingConverter);//$NON-NLS-1$ //$NON-NLS-2$
