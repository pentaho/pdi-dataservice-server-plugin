...
public class JCRRepositoryRevisionBrowserDialog implements RepositoryRevisionBrowserDialogInterface {
	private static Class<?> PKG = JCRRepositoryRevisionBrowserDialog.class; // for i18n purposes, needed by Translator2!!   $NON-NLS-1$
