...
public class RepositoryCleanupUtil {
  ...
  private void validateParameters( Map<String, String> arguments ) throws Exception {
      ...
      if ( f.exists() && f.isDirectory() ) {
        errors.append(
          Messages.getInstance().getString(
            "REPOSITORY_CLEANUP_UTIL.ERROR_0004.FOLDER_EXISTS",
    ...
    if ( aUrl == null ) {
      errors.append(
        Messages.getInstance().getString(
          "REPOSITORY_CLEANUP_UTIL.ERROR_0005.MISSING_PARAM",
          OPTION_PREFIX + URL
        ) + "\n"
      );
    } else {
    ...
    if ( aPurgeFiles != null ) {
      if ( ( aPurgeFiles.equalsIgnoreCase( Boolean.TRUE.toString() )
        ...
        errors.append(
          Messages.getInstance().getString(
            "REPOSITORY_CLEANUP_UTIL.ERROR_0006.INVALID_BOOLEAN",
    ...
    if ( aPurgeRev != null ) {
      if ( aPurgeRev.equalsIgnoreCase( Boolean.TRUE.toString() )
        ...
        if ( isValidOperationSelected ) {
          errors.append(
            Messages.getInstance().getString( "REPOSITORY_CLEANUP_UTIL.ERROR_0010.INVALID_COMBINATION_OF_PARAMS" )
              + "\n"
          );
        } else {
        ...
        try {
          ...
          errors.append(
            Messages.getInstance().getString(
              ...
              OPTION_PREFIX + DEL_DATE + "=" + aDelFrom,
              purgeBeforeDateFormat
            ) + "\n"
          );
        }
      }
    ...
    if ( aVerCount != null ) {
      ...
      if ( isValidOperationSelected ) {
        ...
        try {
          ...
          errors.append(
            Messages.getInstance().getString(
              "REPOSITORY_CLEANUP_UTIL.ERROR_0009.INVALID_INTEGER",
    ...
    if ( !isValidOperationSelected ) {
      errors.append(
        Messages.getInstance().getString( "REPOSITORY_CLEANUP_UTIL.ERROR_0013.MISSING_OPERATION" ) + "\n"
      );
    }
  ...
  private void authenticateLoginCredentials() throws Exception {
    ...
    if ( !response.equals( "true" ) ) {
      throw new Exception(
        Messages.getInstance().getString( "REPOSITORY_CLEANUP_UTIL.ERROR_0012.ACCESS_DENIED" )
      );
    }
  }
  ...
  private String printHelp() {
    ...
    help.append(
      optionHelp(
        URL,
        Messages.getInstance().getString( "REPOSITORY_CLEANUP_UTIL.INFO_0004.URL_REQUIRED", URL )
      )
    );
    ...
    help.append(
      optionHelp(
        USER,
        Messages.getInstance().getString( "REPOSITORY_CLEANUP_UTIL.INFO_0005.USER_REQUIRED", USER )
      )
    );
    ...
    help.append(
      optionHelp(
        PASS,
        Messages.getInstance().getString( "REPOSITORY_CLEANUP_UTIL.INFO_0006.PASS_REQUIRED", PASS )
      )
    );
    ...
    help.append(
      optionHelp(
        VER_COUNT,
        Messages.getInstance().getString( "REPOSITORY_CLEANUP_UTIL.INFO_0009.VERSIONCOUNT_HELP", VER_COUNT )
      )
    );
    ...
    help.append(
      optionHelp(
        DEL_DATE,
        Messages.getInstance().getString( "REPOSITORY_CLEANUP_UTIL.INFO_0010.DATE_HELP", DEL_DATE )
      )
    );
    ...
    help.append(
      optionHelp(
        PURGE_REV,
        Messages.getInstance().getString(
          "REPOSITORY_CLEANUP_UTIL.INFO_0012.PURGE_REVS_HELP",
          PURGE_REV
        )
      )
    );
    ...
    help.append(
      optionHelp(
        LOG_FILE,
        Messages.getInstance().getString(
          "REPOSITORY_CLEANUP_UTIL.INFO_0014.LOGFILE_HELP",
          DEFAULT_LOG_FILE_PREFIX + logFileNameDateFormat,
    ...
    help.append(
      optionHelp(
        LOG_LEVEL,
        Messages.getInstance().getString( "REPOSITORY_CLEANUP_UTIL.INFO_0015.LOGLEVEL_HELP", LOG_LEVEL )
      )
    );
    ...
    help.append(
      indentFormat(
        Messages.getInstance().getString(
          "REPOSITORY_CLEANUP_UTIL.INFO_0017.EXAMPLE_1",
          OPTION_PREFIX + URL,
          OPTION_PREFIX + USER,
          OPTION_PREFIX + PASS,
    ...
    help.append(
      indentFormat(
        Messages.getInstance().getString( "REPOSITORY_CLEANUP_UTIL.INFO_0018.EXAMPLE_1_DESC" ),
        3, 3
      )
    );
    ...
    help.append(
      indentFormat(
        Messages.getInstance().getString(
          "REPOSITORY_CLEANUP_UTIL.INFO_0019.EXAMPLE_2",
          OPTION_PREFIX + URL,
          OPTION_PREFIX + USER,
          OPTION_PREFIX + PASS,
          OPTION_PREFIX + PURGE_TARGET,
    ...
    help.append(
      indentFormat(
        Messages.getInstance().getString( "REPOSITORY_CLEANUP_UTIL.INFO_0020.EXAMPLE_2_DESC" ),
        3, 3
      )
    );
    ...
    help.append(
      indentFormat(
        Messages.getInstance().getString(
          "REPOSITORY_CLEANUP_UTIL.INFO_0021.EXAMPLE_3",
          OPTION_PREFIX + URL,
          OPTION_PREFIX + USER,
          OPTION_PREFIX + PASS,
          OPTION_PREFIX + DEL_DATE
        )
        , 0, 3 ) );
