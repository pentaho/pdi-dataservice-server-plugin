...
@Generated(value = {
    "wadl|file:/C:/env/ws/pdi-ee-plugin/wadl2java/wadl-resource/application.wadl.xml"
}, comments = "wadl2java, http://wadl.java.net", date = "2014-08-06T14:01:32.829-04:00")
public class PentahoDiPlugin {
    ...
    static {
        URI originalURI = URI.create("http://localHost:9080/pentaho-di/plugin/");
    ...
    public static PentahoDiPlugin.PurRepositoryPluginApiRevision purRepositoryPluginApiRevision(com.sun.jersey.api.client.Client client, URI baseURI) {
    ...
    public static PentahoDiPlugin.PurRepositoryPluginApiRevision purRepositoryPluginApiRevision(com.sun.jersey.api.client.Client client) {
        return purRepositoryPluginApiRevision(client, BASE_URI);
    }

    public static PentahoDiPlugin.PurRepositoryPluginApiPurge purRepositoryPluginApiPurge(com.sun.jersey.api.client.Client client, URI baseURI) {
    ...
    public static PentahoDiPlugin.PurRepositoryPluginApiPurge purRepositoryPluginApiPurge(com.sun.jersey.api.client.Client client) {
    ...
    public static class PurRepositoryPluginApiPurge implements IRepositoryService {
        ...
        private PurRepositoryPluginApiPurge(com.sun.jersey.api.client.Client client, UriBuilder uriBuilder, Map<String, Object> map) {
            _client = client;
        ...
        public PentahoDiPlugin.PurRepositoryPluginApiPurge.PathIdPurge pathIdPurge(String pathid) {
            return new PentahoDiPlugin.PurRepositoryPluginApiPurge.PathIdPurge(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), pathid);
        }
    ...
    public static class PurRepositoryPluginApiRevision implements IRepositoryService {
        ...
        private PurRepositoryPluginApiRevision(com.sun.jersey.api.client.Client client, UriBuilder uriBuilder, Map<String, Object> map) {
            _client = client;
            _uriBuilder = uriBuilder.clone();
            _templateAndMatrixParameterValues = map;
        }
        ...
        public PentahoDiPlugin.PurRepositoryPluginApiRevision.PathIdRevisions pathIdRevisions(String pathid) {
            return new PentahoDiPlugin.PurRepositoryPluginApiRevision.PathIdRevisions(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), pathid);
        }

        public PentahoDiPlugin.PurRepositoryPluginApiRevision.VersionCommentsEnabled versionCommentsEnabled() {
            return new PentahoDiPlugin.PurRepositoryPluginApiRevision.VersionCommentsEnabled(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
        }

        public PentahoDiPlugin.PurRepositoryPluginApiRevision.VersioningEnabled versioningEnabled() {
            return new PentahoDiPlugin.PurRepositoryPluginApiRevision.VersioningEnabled(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
        }
        ...
        public static class VersionCommentsEnabled implements IRepositoryService {

            private com.sun.jersey.api.client.Client _client;
            private UriBuilder _uriBuilder;
            private Map<String, Object> _templateAndMatrixParameterValues;

            private VersionCommentsEnabled(com.sun.jersey.api.client.Client client, UriBuilder uriBuilder, Map<String, Object> map) {
                _client = client;
                _uriBuilder = uriBuilder.clone();
                _templateAndMatrixParameterValues = map;
            }
             ...
             * 
             */
            public VersionCommentsEnabled(com.sun.jersey.api.client.Client client, URI baseUri) {
                _client = client;
                _uriBuilder = UriBuilder.fromUri(baseUri);
                _uriBuilder = _uriBuilder.path("/versionCommentsEnabled");
                _templateAndMatrixParameterValues = new HashMap<String, Object>();
            }
        ...
        public static class VersioningEnabled implements IRepositoryService {

            private com.sun.jersey.api.client.Client _client;
            private UriBuilder _uriBuilder;
            private Map<String, Object> _templateAndMatrixParameterValues;

            private VersioningEnabled(com.sun.jersey.api.client.Client client, UriBuilder uriBuilder, Map<String, Object> map) {
                _client = client;
                _uriBuilder = uriBuilder.clone();
                _templateAndMatrixParameterValues = map;
            }
             ...
             * 
             */
            public VersioningEnabled(com.sun.jersey.api.client.Client client, URI baseUri) {
                _client = client;
                _uriBuilder = UriBuilder.fromUri(baseUri);
                _uriBuilder = _uriBuilder.path("/versioningEnabled");
                _templateAndMatrixParameterValues = new HashMap<String, Object>();
            }
